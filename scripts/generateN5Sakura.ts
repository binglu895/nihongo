...
const OUTPUT_DIR = path.join(process.cwd(), "public", "audio", "listening", "n5_sakura");
...
async function generateSakuraAudio(text: string, filename: string) {
    console.log(`Generating Sakura audio for: "${text}"`);
...
async function main() {
    console.log("Starting N5 Sakura audio generation...");
    ...
    for (const q of questions) {
        ...
        // Small delay to be nice to the API, though ElevenLabs is generous
